...
const createAnimation = (scrollstart: number, scrollEnd: number, valueStart: number, valueEnd: number) => {
    ...
    <main>
      <div className="main-conteiner">
        <div className="logo-title">
          <div className="logo">
            <Image src={'/assets/images/dingding/logo.svg'} alt="" width={100} height={100} />
          </div>
          <div className="title">
            <Image src={'/assets/images/dingding/title.png'} alt="" width={100} height={100} />
          </div>
        </div>
        ...
        <div className="last-area">
          <Image src={'/assets/images/dingding/title-1.png'} alt="" width={'100'} height={'100'} />
